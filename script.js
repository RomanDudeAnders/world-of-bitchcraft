...
function generateReview() {
    ...
    const eyesComments = [
        ...
        "Die Augen sind ja wirklich nicht schlecht, aber hast du es mit dem Eyeliner nicht ein kleines Bisschen übertrieben?",
        "Die Augen deines Hundes siehen ja nicht schlecht aus, aber können sie auch sehen? Dein Wuffi hat mich gar nicht erkannt! Ich bin es doch, Bitchbaron69, der Juror der Hundeherzen!",
        "Beim Anblick deines Hundes wird mir klar: Das Wort Glupschauge bekommt eine völlig neue Bedeutung. Ich liebe Glupschaugen!",
        "Erstmal zu den Augen: Wenn Blicke töten könnten, wäre ich nicht mehr hier. Wer wagt es denn bitte, so einen Juror anzustarren?",
        "Die Augen deines Hundes sind ziemlich normal. Für etwas mehr BÄM empfehle ich Laseraugen. Nein, mir ist egal, ob das albern ist. Ich vergebe hier die Sterne!",
    ...
    const furComments = [
        ...
        "Das Fell... Naja, ich denke mal platt auf dem Boden wäre es ein ganz netter Fußwärmer. Aber an einem HUND???",
        "Beim Fell hattest du keine Lust mehr, oder? Da wäre wirklich mehr drin gewesen. Lass das nicht den Glööckler sehen...",
        "Für das nächste Mal hätte ich übrigens noch einen Vorschlag: Fell in bunten Regenbogenfarben! Ach, ich bin so genial, ich sollte viel mehr eigene Hunde kreieren. Da könnten sich alle anderen ne gehörige Scheibe von abschneiden. Bitte? Achso... Na gut, zurück zu deinem – nennen wir es mal Hund.",
        "Zum Fell würde ich sagen: Das tauschen wir nochmal aus. Und danach vielleicht auch noch den Rest des Hundes, dann hat er Potenzial.",
        "Und vergiss nicht, dein Hündchen niemals gegen den Strich zu kraulen. Dann guckt er auch nicht mehr so grimmig.",
    ...
    const noseComments = [
        ...
        "Die Schnauze – moment mal, ist das etwa... Ja, tatsächlich! Die Schnauze sieht aus wie Michael Jackson! Hoffentlich fällt sie nicht ab.",
        "Hast du deinen Hund etwa mit Schwarzwälder Kirchtorte gefüttert? Da sind noch Reste an der Schnauze. Ich verstehe ja die Hingabe, mit der du dein liebes Tierchen versorgen willst, aber SO begibt man sich nicht vor einen Star-Juror!",
        "Beim Blick auf die Schnauze wird ganz deutlich, dass Hunde so aussehen wie ihre Besitzer, findest du nicht auch?",
        "Jetzt müssen wir mal über die Schnauze reden. So ganz unter uns. Und das mein ich jetzt gar nicht böse. Aber ganz ehrlich, wie soll dein Hund mit dieser lächerlichen Schnauze denn bitte Stöckchen holen? Da passt ja kaum ne Gurke rein.",
        "Und jetzt mal frei Schnauze: Dein Hund hat einen prächtigen Rüssel! Ich bin hin und weg! Die Idee klaue ich mir für meinen nächsten Hund.",
    ...
    const tailComments = [
        ...
        "Weißt du was das größte Problem von Schwänzen ist? Sie sind immer hinten! Was soll das? Jetzt muss ich den Hund erst umdrehen, um den Schwanz zu begutachten, und schon sehe ich die Schnauze nicht mehr. Tja, hier hat die Evolution versagt. Aber weißt du was, ich glaube dir einfach, dass der Schwanz toll geworden ist!",
        "Über Schwänze kann man ja vorzüglich streiten, aber ich (und ich bin hier schließlich der Juror!) habe da eine ganz klare Meinung: Der Schwanz ist dazu da, den Hintern zu verdecken! Also sag deinem Hund, er soll ihn unten lassen!",
        "Ein Schwanz kommt selten allein! Ja, ganz genau, ich habe dich ertappt! Den Schwanz hast du doch von dem Premiumhund Süßlinde kopiert! Das geht absolut nicht klar! Ich bewerte Kreativität.",
        "Wenn ich mir die Schwanzstellung deines Hundis so ansehe, bin ich mir sicher: Vorsicht, gleich kommt ein Häufchen! Also los, kommen wir mal lieber schnell zum Ende...",
        "Der Schwanz deines Hundes ist sehenswert. Vielleicht solltest du noch eine Schleife drumbinden! Das würde seine Pfoten unterstreichen.",
        "Der Blick von hinten offenbart dem geschulten Auge: Dein Kläffer ist schwanztastisch!",
    ...
    const nameComments = {
        ...
        karl: "Der Name deines Hundes ist zwar ziemlich witzig, aber ich glaube der Gag nutzt sich schnell ab. Du solltest den WauWau nächste Woche umbenennen.",
        adalbert: "Der Name deines Hundes ist zwar ziemlich witzig, aber ich glaube der Gag nutzt sich schnell ab. Du solltest den WauWau nächste Woche umbenennen.",
        ...
        edeltraut: "Endlich mal jemand, der einen klassischen Hundenamen aussucht! Wobei... Eigentlich sieht sie mehr aus wie eine Grete, oder?",
